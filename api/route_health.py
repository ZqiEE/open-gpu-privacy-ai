...
class RouteHealth:
    ...
    def check(self, route_key: str = "owned-chat/default", verify_artifact: bool = False) -> dict[str, Any]:
    ...
    def disable_if_bad(self, route_key: str = "owned-chat/default", reason: str = "route_health_failed", verify_artifact: bool = False) -> dict[str, Any]:
        status = self.check(route_key, verify_artifact=verify_artifact)
        if status.get("ok"):
